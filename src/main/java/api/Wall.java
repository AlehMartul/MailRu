...
public class Wall {
    ...
    public void postMessage() {
        try {
            URIBuilder builder = new Builder.builder("wall.post")
                    .setAccessToken()
                    .setOwnerID()
                    .setMessageText()
                    .build();
    ...
    public void editMessage() {
        try {
            URIBuilder builder = new Builder.builder("wall.edit")
                    .setAccessToken()
                    .setOwnerID()
    ...
    public void deleteMessage() {
        try {
            URIBuilder builder = new Builder.builder("wall.delete")
                    .setAccessToken()
                    .setOwnerID()
                    .setPostID(postID)
                    .build();
    ...
    public boolean findMatchesOnWallByRegEx(String regex) {
        ...
        try {
            URIBuilder builder = new Builder.builder("wall.get")
                    .setAccessToken()
                    .setOwnerID()
                    .build();
            HttpResponse response = getHttpResponse(builder, client);
